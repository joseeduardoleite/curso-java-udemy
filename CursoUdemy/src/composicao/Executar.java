...
public class Executar {
	public static void exe() throws ParseException {
		...
		int month = Integer.parseInt(monthAndYear.substring(0, 2)); // recorta a string da posicao 0 à 2 (MM) 
		int year = Integer.parseInt(monthAndYear.substring(3)); // recorta da posição 3 em diante (YYYY)
